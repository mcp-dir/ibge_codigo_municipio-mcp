...
IBGE: Código de Município segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [ibge_codigo_municipio@mcp.ai](mailto:ibge_codigo_municipio@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
